 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content form-control ">
    ...
    <section class="content" >
    	...
    	<div class=" text-center" style="font-size: 20px;">{{ $profile->email }}</div>
    <div class="row" >
	    	...
	    	<div class="box box-primary">
		      <div class="form-group" style="padding: 5px;">
		        ...
		        <p class="help-block text-red">Upload image size under 2 Mb.</p>
		     	   ...
		     	   @else
		     	   <img class="profile-user-img  img-fluid mx-auto d-block" name="image" src="{{ URL::to(Auth::user()->image) }}" alt="User profile picture">
		     	   @endif 
